...
export const family: FamilyTool[] = [
  {
    ...
    proof:
      "Oniguruma has powered TextMate grammars and half the editors you know. ferroni keeps its entire feature class and exact behavior — rebuilt in pure Rust: no C toolchain, faster in the hot path, proven against Oniguruma's own tests.",
    version: "1.3.0",
    status: "stable",
    registry: "crates.io",
  ...
  },
  {
    ...
    compat: "Shiki",
    proof:
      "Shiki brought editor-grade highlighting to everyone. ferriki keeps the API Shiki got right and swaps the JS-and-WASM engine underneath for native Rust — same tokens, same themes, verified against Shiki's own test suite.",
    version: "0.2.0",
    status: "alpha",
    registry: "npm",
  ...
  },
  {
    ...
    proof:
      "CommonMark settled what Markdown means. ferromark renders every last rule of it — plus all of GFM, sanitized by default — and does it ahead of pulldown-cmark and md4c, the fastest parsers before it.",
    version: "0.7.0",
    status: "beta",
    registry: "crates.io",
  ...
  },
  {
    ...
    compat: "Hunspell",
    proof:
      "Hunspell has spell-checked the world's software for decades. ferrolex speaks its dictionaries fluently — and adds what a modern engine owes you: compiled dictionaries, deterministic suggestions, code-aware checking, scored openly against Hunspell itself.",
    version: "0.2.0",
    status: "alpha",
    registry: "crates.io",
  ...
  },
  {
    ...
    proof:
      "gettext taught software to speak in catalogs. ferrocat brings the catalog into the git-and-AI era: merges that don't conflict, releases that audit themselves, and human corrections no machine translation can overwrite.",
    version: "3.4.2",
    status: "stable",
    registry: "crates.io",
    registries: "crates.io",
  ...
  },
  {
    ...
    proof:
      "PDF previews used to mean embedding a browser-sized engine. ferrugo renders untrusted files inside hard limits — bounded memory, bounded time, no PDFium — built for servers that can't afford surprises.",
    version: "0.5.0",
    status: "early",
    registry: "crates.io",
    registries: "crates.io",
