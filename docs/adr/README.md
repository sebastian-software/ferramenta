...
| ADR                                                                | Decision                                                               | Status                       |
| ------------------------------------------------------------------ | ---------------------------------------------------------------------- | ---------------------------- |
| [0001](0001-decentralized-homepages-with-shared-family-package.md) | Decentralized project homepages, one shared family package             | accepted, amended 2026-09-25 |
...
**Who is in the family.** A member is a family engine, a product built on
family engines, or a selected standalone Rust-native application that fits the
family's product thesis. Rust source and shared ownership alone are not enough —
see the [ADR-0001 amendment of 2026-09-25](0001-decentralized-homepages-with-shared-family-package.md#amendment-2026-09-25).
