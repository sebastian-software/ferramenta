...
| ------------------ | ------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `icon-candidates/` | Streamline Duotone and Ultimate exports, one folder per motif | The shortlist the project marks were chosen from. The chosen marks live in `packages/family/src/mark-defs.ts`. |
...
`packages/family/fonts/big-shoulders.woff2` (ADR-0003).
