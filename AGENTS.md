...
| `design/comp/`                       | Approved design comp (`entwurf-c.html`) + partner logos                                                                                                                    |
| `design/archive/`                    | Decision residue: rejected display faces and the Streamline icon shortlist. Nothing here is built or shipped                                                               |
